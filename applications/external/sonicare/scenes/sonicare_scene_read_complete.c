...
void sonicare_scene_read_complete_widget_callback(
...
void sonicare_scene_read_complete_on_enter(void* context) {
    ...
    */
    ...
    uint32_t unlock_pwd_big = get_sonicare_password(
        (uint8_t*)ul_data->iso14443_3a_data->uid, (uint8_t*)furi_string_get_cstr(serial_no));
